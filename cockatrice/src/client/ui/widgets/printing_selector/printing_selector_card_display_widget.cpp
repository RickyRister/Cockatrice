 ...
 * @param _printingInfo The set-specific information for the card being displayed.
      ...
      currentZone(_currentZone)
{
    ...
    const QString combinedSetName =
        QString(printingInfo.getPtr()->getLongName() + " (" + printingInfo.getPtr()->getShortName() + ")");
    setNameAndCollectorsNumberDisplayWidget = new SetNameAndCollectorsNumberDisplayWidget(
        this, combinedSetName, printingInfo.getProperty("num"), cardSizeSlider);
