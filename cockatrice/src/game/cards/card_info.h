...
typedef QMap<QString, QList<PrintingInfo>> SetToPrintingInfoMap;
...
public:
    ...
    const SetToPrintingInfoMap &getSets() const
    {
        return sets;
    }
